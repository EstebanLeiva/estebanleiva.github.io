...
summary: "A regularized inverse reinforcement learning framework that incorporates prior beliefs to learn cost functions and policies from suboptimal expert demonstrations in Markov decision processes."
---
